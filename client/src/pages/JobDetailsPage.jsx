    ...
    <div className="py-2">
      <PageHeader>
        ...
        <Sheet className="w-2xl">
          ...
          {error && (
            <p className="mb-3 max-w-3xl text-sm text-red-500">
              Error: {error}
            </p>
          )}

          {!error && (
            <div className="mb-3 max-w-3xl text-sm text-neutral-500">
              {loading
          ...
          <SheetContent>
            <SheetHeader>
              ...
              <SheetTitle>{job ? job.title : ""}</SheetTitle>
              <SheetDescription>{job ? job.description : ""}</SheetDescription>
            </SheetHeader>
